            ...
            <div className="bg-black w-full py-20 flex flex-col items-center justify-center text-white">
                ...
                <div ref={scrollContainerRef} className="w-full overflow-y-auto my-16 mx-2 scrollbar-hide">
                    ...
                    <div className="flex space-x-4">
                        ...
                        <ReviewCard position="CITL + Teaching and Learning Team" img="reviews/5.jpg" name="University of Illinois GEIS College of Business"  review="MetaFrazo has a great product that allows educational content to be repurposed at high quality, personalized audio, and the text-on screen translation is great"/>

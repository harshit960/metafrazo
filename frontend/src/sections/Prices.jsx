    ...
    return (
        <>
            <div className="bg-black w-full flex flex-col justify-center items-center text-white h-[1336px] ">
                ...
                <div className="text-[56px] z-20 font-bold my-6">Pricing plans for all use cases</div>
                <div className="text-[20px] z-20">Unlock a world of international engagement with our effortless, cutting-edge solution</div>
                <div className="flex items-center justify-center z-20 space-x-6 mt-16">
                    <div className="text-[20px] font-bold">Annually</div>

    ...
    return (
        <>
            <div className="flex flex-col items-center justify-center ">
                ...
                <div className="lg:text-[64px] text-4xl flex  font-montserrat text-white font-bold text-center leading-none	">
                    Perfect Lip Sync for Videos
                    <br />
                {/* </div>
                <div className="text-[72px] flex  font-montserrat text-white font-bold text-center"> */}
                    within seconds

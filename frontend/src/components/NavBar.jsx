        ...
        <>
            <div className='left-0 top-0 w-full flex justify-between text-white p-4 pt-8 absolute'>
                ...
                <div className=" flex text-base">
                    ...
                    <div className="text mx-4">About</div>
                    <div className="text mx-4">Product</div>
                    <div className="text mx-4">Price</div>
                    <div className="text mx-4">Contact</div>
                </div>
                <div className="flex ">
                    <svg className='mx-2' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#fff" fill="none">
